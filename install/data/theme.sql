...
UPDATE `PREFIX_configuration` SET value = 'http://www.milebiz.com' WHERE name = 'BLOCKADVERT_LINK';
...
UPDATE `PREFIX_configuration` SET value = 'http://www.facebook.com/milebiz' WHERE name = 'blocksocial_facebook';
UPDATE `PREFIX_configuration` SET value = 'http://www.twitter.com/milebiz' WHERE name = 'blocksocial_twitter';
UPDATE `PREFIX_configuration` SET value = 'RSS' WHERE name = 'blocksocial_rss';
UPDATE `PREFIX_configuration` SET value = '米乐工作室' WHERE name = 'blockcontactinfos_company';
UPDATE `PREFIX_configuration` SET value = '浙江省\n杭州市\n拱墅区 310000' WHERE name = 'blockcontactinfos_address';
UPDATE `PREFIX_configuration` SET value = '+86 (0)13777458099' WHERE name = 'blockcontactinfos_phone';
UPDATE `PREFIX_configuration` SET value = 'admin@milebiz.com' WHERE name = 'blockcontactinfos_email';
UPDATE `PREFIX_configuration` SET value = '+86 (0)13777458099' WHERE name = 'blockcontact_telnumber';
UPDATE `PREFIX_configuration` SET value = 'admin@milebiz.com' WHERE name = 'blockcontact_email';
