...
UPDATE `PREFIX_configuration` SET value = 'paypal@milebiz.com' WHERE name = 'PAYPAL_BUSINESS' AND value = 'your-address@paypal.com';
...
(4, 1, '', 'Shop powered by MileBiz', 'shop, milebiz'),
(4, 2, '', 'Boutique propulsé par MileBiz', 'boutique, milebiz'),
...
(1, 1, '配送', '配送协议', '配送, 协议, 运输, 包装', '<h2>配送及退货</h2><h3>配送</h3><p>一般在付款完成后的2天内完成包装并配送。通常使用顺丰、申通等快递，如果你需要使用其他指定快递，可能需要其他额外的费用，所以请在购买前先进行沟通。</p><p>费用包含运输费和包装费。运输费一般根据配送重量计算。如果两个商品运往同一地点，我们建议一起配送。配送风险将由您个人承担。<br /><br />包装为普通包装盒</p>', 'delivery');
INSERT INTO `PREFIX_cms_lang` (`id_cms`, `id_lang`, `meta_title`, `meta_description`, `meta_keywords`, `content`, `link_rewrite`) VALUES
(2, 1, 'Legal Notice', 'Legal notice', 'notice, legal, credits', '<h2>Legal</h2><h3>Credits</h3><p>Concept and production:</p><p>This Web site was created using <a href="http://www.milebiz.com">MileBiz</a>&trade; open-source software.</p>', 'legal-notice');
INSERT INTO `PREFIX_cms_lang` (`id_cms`, `id_lang`, `meta_title`, `meta_description`, `meta_keywords`, `content`, `link_rewrite`) VALUES
(3, 1, '条款与细则', '条款及细则', '条款, 细则, 使用, 购买', '<h2>使用条款及细则</h2><h3>条款1</h3><p>这是使用条款1的内容</p>\r\n<h3>条款2</h3><p>这是使用条款2的内容</p>\r\n<h3>条款3</h3><p>这是使用条款3的内容</p>\r\n', 'terms-and-conditions-of-use');
INSERT INTO `PREFIX_cms_lang` (`id_cms`, `id_lang`, `meta_title`, `meta_description`, `meta_keywords`, `content`, `link_rewrite`) VALUES
(4, 1, '关于我们', '关于我们', '关于我们, 信息', '<h2>关于我们</h2>\r\n<h3>我们的公司</h3><p>我怕们的公司</p>\r\n<h3>我们的团队</h3><p>我们的团队</p>\r\n<h3>其他信息</h3><p>其他信息</p>', 'about-us');
INSERT INTO `PREFIX_cms_lang` (`id_cms`, `id_lang`, `meta_title`, `meta_description`, `meta_keywords`, `content`, `link_rewrite`) VALUES
(5, 1, '安全支付', '安全支付', '安全支付, ssl, visa, mastercard, 支付宝', '<h2>安全支付</h2>\r\n<h3>安全支付</h3><p>使用 SSL</p>\r\n<h3>使用银联 或 支付宝</h3><p>关于这项服务</p>', 'secure-payment');
