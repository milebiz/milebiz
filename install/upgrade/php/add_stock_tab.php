...
function add_stock_tab()
{
	...
	add_new_tab(
		'AdminWarehouses',
		'en:Warehouses|fr:Entrep么ts|es:Warehouses|de:Warehouses|it:Warehouses',
		$id_parent);
	...
	add_new_tab(
		...
		'en:Stock instant state|fr:Etat instantan茅 du stock|es:Stock instant state|de:Stock instant state|it:Stock instant state',
		$id_parent);
