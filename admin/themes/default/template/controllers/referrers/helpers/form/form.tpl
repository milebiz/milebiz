			...
			<div id="tracking_help" style="display: none;">
				...
				<ul style="list-style: disc; margin-left: 20px;">
					<li>
						...
						{l s='For example, visitors coming from Google will have a `http_referer` like this one: "http://www.google.com/search?q=milebiz".'}<br />
					...
					<li>
						...
						{l s='For example, you can post a link "%dindex.php?milebiz" in the forum and get statistics by entering "%milebiz" in the field `request_uri`. You will get all the visitors coming from the forum.'}
