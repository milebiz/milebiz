...
<script type="text/javascript">
	...
	var by = '{l s='by'}';
	var errorLogin = '{l s='MileBiz was unable to login to Addons, please check your credentials and your internet connection.'}';
	...
	$('document').ready( function() {
		...
		// Method to get modules_list.xml from milebiz.com and default_country_modules_list.xml from addons.milebiz.com
		try
		{
			resAjax = $.ajax({
					type:"POST",
		...
		// Method to log on MileBiz Addons WebServices
		...
		// Method to log out MileBiz Addons WebServices
