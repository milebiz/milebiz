...
{if $add_permission eq '1'}
	{if isset($logged_on_addons)}
			...
			<div class="filter-module" id="addons_login_div">
				...
				<p>{l s='You are logged into MileBiz Addons'}</p>
				
				<div style="float:right">				
					<label><img src="themes/default/img/module-profile.png" /> {l s='Welcome'} {$username_addons}</label>
					<label>|</label>
					<label><a href="#" id="addons_logout_button"><img src="themes/default/img/module-logout.png" /> {l s='Log out from MileBiz Addons'}</a></label>
				</div>
	...
	{else}
		...
		{else}
			...
			<div class="filter-module" id="addons_login_div">
				...
				<p>{l s='Do you have a %s account?' sprintf='<a href="http://addons.milebiz.com/">MileBiz Addons</a>'}</p>
