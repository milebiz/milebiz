...
{block name="override_tpl"}
	...
	<fieldset>
		...
		{l s='Here you can modify translations for all text input in MileBiz.'}<br />
	...
	<form action="{$url_submit}" method="post" enctype="multipart/form-data">
		<fieldset>
			...
			<div id="submitAddLangContent" style="float:left;">
				<p>{l s='You can add or update a language directly from milebiz.com here'}</p>
				<div class="warn">
				...
				{else}
					<br /><br /><p class="error">{l s='Cannot connect to milebiz.com to get language list.'}</p></div>
				{/if}
			</div>
		</fieldset>
	</form><br /><br />
