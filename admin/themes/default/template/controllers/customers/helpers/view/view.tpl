...
<div class="clear"></div>
	...
	{if count($messages)}
		...
		<div class="clear">&nbsp;</div>
	{else}
		{l s='%1$s %2$s has never contacted you' sprintf=[$customer->lastname, $customer->firstname]}
	{/if}
	...
	{if $orders AND count($orders)}
		...
		{/if}
	{else}
		{l s='%1$s %2$s has not placed any orders yet' sprintf=[$customer->lastname, $customer->firstname]}
	{/if}
	...
	{else}
		{l s='%1$s %2$s has not registered any addresses yet' sprintf=[$customer->lastname, $customer->firstname]}
	{/if}
	...
	{else}
		{l s='%1$s %2$s has no discount vouchers' sprintf=[$customer->lastname, $customer->firstname]}.
	{/if}
	<div class="clear">&nbsp;</div>
