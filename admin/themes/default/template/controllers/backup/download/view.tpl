...
{block name="override_tpl"}
	...
	<div class="error width1" style="float: left; margin-right: 10px;">
		...
		<ol style="font-size: 11px; font-weight: normal; line-height: 20px; padding-left: 10px;">
			<li>{l s='MileBiz is not responsible for your database, Backups, data and recovery.'}</li>
			<li>{l s='MileBiz is Open-source software, you are using it at your own risk under the license agreement.'}</li>
