	...
	<fieldset style="float: left; margin: 0pt 20px 0pt 0pt; width: 70%;">
		...
		{if !count($files_to_import)}
			<div class="warn" style="margin-top: 20px;">
				...
				<ul>
					<li>{l s='You can read informations on CSV import at:'} <a href="http://doc.milebiz.com/display/PS14/Troubleshooting#Troubleshooting-HowtocorrectlyimportaccentuatedcontentusingaCSVfile%3F" target="_blank">http://doc.milebiz.com/display/PS14/Troubleshooting</a></li>
