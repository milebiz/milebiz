...
class AdminControllerCore extends Controller
{
	...
	protected $addons_url = 'api.addons.milebiz.com';
	...
	public function __construct()
	{
		...
		// Has to be remove for the next MileBiz version
		global $token;
	...
	{
		// Has to be removed for the next MileBiz version
		global $currentIndex;
	...
	public function getList($id_lang, $order_by = null, $order_way = null, $start = 0, $limit = null, $id_lang_shop = false)
	{
		...
		if (!Validate::isTableOrIdentifier($this->table))
			throw new MileBizException(sprintf('Table name %s is invalid:', $this->table));
		...
		if (!Validate::isOrderBy($order_by) || !Validate::isOrderWay($order_way)
			...
			throw new MileBizException('get list params is not valid');
