...
class ProductCore extends ObjectModel
{
	...
	*/
		...
		$use_customer_price = true)
	{
		...
		{
			/*
			* When a user (e.g., guest, customer, Google...) is on MileBiz, he has already its cart as the global (see /init.php)
			* When a non-user calls directly this method (e.g., payment module...) is on MileBiz, he does not have already it BUT knows the cart ID
