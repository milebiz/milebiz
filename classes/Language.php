	...
	public static function checkAndAddLanguage($iso_code)
	{
		...
		else
		{
			if (@fsockopen('www.milebiz.com', 80))
			{
				...
				if ($lang_pack = Tools::jsonDecode(Tools::file_get_contents('http://www.milebiz.com/download/lang_packs/get_language_pack.php?version='._PS_VERSION_.'&iso_lang='.$iso_code)))
				{
				...
				if ($lang_pack)
				{
					$flag = Tools::file_get_contents('http://www.milebiz.com/download/lang_packs/flags/jpeg/'.$iso_code.'.jpg');
