...
class WebserviceRequestCore
{
	...
	/**
	 * Base MileBiz webservice URL
	 * @var string
	 */
	public $wsUrl;

	/**
	 * MileBiz Webservice Documentation URL
	 * @var string
	 */
	protected $_docUrl = 'http://doc.milebiz.com/display/PS14/Using+the+REST+webservice';
	...
	/**
	 * The current object to support, it extends the MileBiz ObjectModel
	 * @var ObjectModel
	 */
	protected $_object;
	...
	protected function isActivated()
	{
		...
		{
			$this->setError(503, 'The MileBiz webservice is disabled. Please activate it in the MileBiz Back Office', 22);
			return false;
		}
		return true;
	}
	...
	/**
	 * Execute POST method on a MileBiz entity
	 *
	 * @return boolean
	 */
	...
	/**
	 * Execute PUT method on a MileBiz entity
	 *
	 * @return boolean
	 */
	...
	/**
	 * Execute DELETE method on a MileBiz entity
	 *
	 * @return boolean
	 */
	...
	protected function returnOutput()
	{
		...
		$this->objOutput->setHeaderParams('Access-Time', time())
						->setHeaderParams('X-Powered-By', 'MileBiz Webservice')
