...
class ValidateCore
{
	...
	{
		return preg_match('/^[^0-9!<>,;?=+()@#"掳{}_$%:]*$/u', stripslashes($name));
	}
	...
	*/
	...
	{
		return preg_match('/^[^!<>,;?=+()@"掳{}_$%:]{3,32}$/u', $voucher);
	}
	...
	/**
	 * Check if $data is a MileBiz cookie object
	 *
