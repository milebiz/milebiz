...
class CategoryCore extends ObjectModel
{
	...
	public function update($null_values = false)
	{
		if ($this->id_parent == $this->id)
			throw new MileBizException('a category cannot be it\'s own parent');
	...
	public function calcLevelDepth()
	{
		...
		if (!Validate::isLoadedObject($parent_category))
			throw new MileBizException('Parent category does not exist');
	...
	public function recalculateLevelDepth($id_category)
	{
		if (!is_numeric($id_category))
			throw new MileBizException('id category is not numeric');
		/* Gets all children */
