...
class UpgraderCore
{
	...
	public $rss_version_link = 'http://api.milebiz.com/xml/upgrader.xml';
	public $rss_md5file_link_dir = 'http://api.milebiz.com/xml/md5/';
	/**
	...
	/**
	 * downloadLast download the last version of MileBiz and save it in $dest/$filename
	 *
	 ...
	 */
	public function downloadLast($dest, $filename = 'milebiz.zip')
	{
		if (empty($this->link))
			$this->checkPSVersion();
	...
	/**
	 * checkPSVersion ask to milebiz.com if there is a new version. return an array if yes, false otherwise
	 *
	 * @return mixed
	 */
	...
	public function isAuthenticMileBizVersion()
	{
