	...
	public function __construct()
	{
		...
		$this->fields_options = array(
			'change' => array(
				...
				'description' => $this->l('Use MileBiz\'s webservice to update your currency exchange rates. Please use caution, rates are provided as-is.'),
				'submit' => array(
			...
			'cron' => array(
				...
				'info' => $this->l('Use MileBiz\'s webservice to update your currency exchange rates. Please use caution, rates are provided as-is. Place this URL in crontab or access it manually daily').':<br />
		...
		$this->fields_form = array(
			...
			'input' => array(
				...
				array(
					...
					'maxlength' => 8,
					'required' => true,
					'desc' => $this->l('Will appear in Front Office (e.g. $, â‚¬)').'...',
				),
				array(
					'type' => 'text',
