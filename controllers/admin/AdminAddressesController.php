...
class AdminAddressesControllerCore extends AdminController
{
	...
	public function __construct()
	{
		...
		$this->fields_list = array(
			...
			'city' => array('title' => $this->l('City'), 'width' => 150, 'filter_key' => 'ct!name'),
	...
	{
		$this->_select = 'cl.`name` as country, ct.`name` as city';
		$this->_join = '
		...
		foreach ($addresses_fields as $addr_field_item)
		{
			...
			else if ($addr_field_item == 'lastname')
			{
				...
				$temp_fields[] = array(
					...
					'size' => 33,
					'required' => true,
					'hint' => $this->l('Invalid characters:').' 0-9!<>,;?=+()@#"锟絳}_$%:<span class="hint-pointer">&nbsp;</span>',
