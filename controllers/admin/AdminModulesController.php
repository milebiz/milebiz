...
class AdminModulesControllerCore extends AdminController
{
	...
	*/
	...
	protected $filter_configuration = array();
 	...
 	protected $xml_modules_list = 'api.milebiz.com/xml/modules_list_15.xml';
	...
	private function sendStatisticRequest($object_key)
	{
		...
		file_get_contents('http://api.addons.milebiz.com/', false, $context);
	}
					...
					else
					{
						...
						// We check if method of module exists
							if (!method_exists($module, $method))
								throw new MileBizException('Method of module can\'t be found');
