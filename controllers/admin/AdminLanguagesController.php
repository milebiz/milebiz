...
class AdminLanguagesControllerCore extends AdminController
{
	...
	public function ajaxProcessCheckLangPack()
	{
		...
		if (@fsockopen('www.milebiz.com', 80))
		{
			...
			$lang_packs = Tools::file_get_contents('http://www.milebiz.com/download/lang_packs/get_language_pack.php?version='.(string)$_GET['ps_version'].'&iso_lang='.(string)$_GET['iso_lang']);
