...
class AdminPerformanceControllerCore extends AdminController
{
	...
	public function initFieldsetCCC()
	{
		$this->fields_form[2]['form'] = array(
			...
			'desc' => $this->l('CCC allows you to reduce the loading time of your page. With these settings you will gain performance without even touching the code of your theme. Make sure, however, that your theme is compatible with MileBiz 1.4+. Otherwise, CCC will cause problems.'),
			'input' => array(
				array(
					'type' => 'hidden',
					'name' => 'ccc_up',
	...
	public function initFieldsetCloudCache()
	{
		if (!class_exists('CloudCache'))
			...
			<a style="color: blue" href="index.php?controller=AdminModules&token='.Tools::getAdminTokenLite('AdminModules').'&filtername=cloudcache" id="installCloudCache">&gt; '.$this->l('Click here to install the CloudCache module for MileBiz').'</a><br />'
		);
	}
