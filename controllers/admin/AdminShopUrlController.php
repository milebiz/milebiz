...
class AdminShopUrlControllerCore extends AdminController
{
	...
	public function renderForm()
	{
		...
		if (!$update_htaccess)
			...
			$desc_virtual_uri = array(
				$this->l('You can use this option if you want to create a store with a URI that doesn\'t exist on your server (e.g. if you want your store to be available with the URL www.my-milebiz.com/my-store/shoes/, you have to set shoes/ in this field, assuming that my-store/ is your Physical URI).'),
				...
				'form' => array(
					...
					'input' => array(
						...
						array(
							...
							'name' => 'physical_uri',
							'desc' => $this->l('Physical folder of your store on your server. Leave this field empty if your store is installed on the root path (e.g. if your store is available at www.my-milebiz.com/my-store/, you would set my-store/ in this field).'),
							'size' => 50,
						),
						array(
							'type' => 'text',
