...
class OrderOpcControllerCore extends ParentOrderController
{
			...
			if (Tools::isSubmit('ajax'))
			{
				if (Tools::isSubmit('method'))
				{
					switch (Tools::getValue('method'))
					{
						...
						default:
							throw new MileBizException('Unknown method "'.Tools::getValue('method').'"');
					}
				}
				else
					throw new MileBizException('Method is not defined');
			}
		}
	...
	protected function _getGuestInformations()
	{
		...
		return array(
			...
			'id_city' => Tools::htmlentitiesUTF8($address_delivery->id_city),
