...
{*
** Retro compatibility for MileBiz version < 1.4.2.5 with a recent theme
...
{if !isset($formatedAddressFieldsValuesList)}
	...
	{* MileBiz 1.4.0.17 compatibility *}
	{if isset($addresses)}
...
{/if}
	<div class="addresses clearfix">
		...
		<div class="clearfix">
			<ul class="address item full_width" id="address_delivery" {if $cart->isVirtualCart()}style="display:none;"{/if}>
			</ul>
		</div>
