...
class Loyalty extends Module
{
	...
	public function install()
	{
		...
		$defaultTranslations = array('en' => 'Loyalty reward', 'fr' => 'R茅compense fid茅lit茅');
...
//            redirect($this->context->link);
	...
	public function getContent()
	{
		...
		$languageIds = 'voucher_details陇default_loyalty_state陇none_award_loyalty_state陇convert_loyalty_state陇validation_loyalty_state陇cancel_loyalty_state';
