...
class BlockLayered extends Module
{
	...
	public function translateWord($string, $id_lang ) 
	{
		...
		$default_key = '<{'.strtolower( $this->name).'}milebiz>'.strtolower($this->name).'_'.md5($string);
	...
	public function hookFeatureValueForm($params)
	{
		...
		$return .= '<div class="clear"></div>
				...
				<script type="text/javascript">
					flag_fields += \'Â¤url_nameÂ¤meta_title\';
				</script>
	...
	/**
	 * Define our own Tools::unSerialize() (since 1.5), to be available in MileBiz 1.4
	 */
