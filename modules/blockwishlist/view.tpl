...
{if $wishlists}
<p>
	{l s='Other wishlists of' mod='blockwishlist'} {$current_wishlist.lastname}{$current_wishlist.firstname}:
...
<div class="addresses" id="featured-products_block_center">
	<h3>{l s='Welcome to the wishlist of' mod='blockwishlist'} {$current_wishlist.lastname}{$current_wishlist.firstname}: {$current_wishlist.name}</h3>
	<p />
